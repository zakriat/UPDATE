...
<div class="card">
    <div class="card-body" id="landlord-settings-form">
        ...
        <div class="alert alert-info">@lang('lang.account_settings_info')</div>
        ...
        <form class="form" id="settingsFormGeneral">
                ...
                <div class="col-12">
                    <select class="select2-basic form-control form-control-sm" id="defaults_language_default"
                        ...
                        <option value="{{ $language }}"
                            {{ runtimePreselected($language, $defaults->defaults_language_default ?? '') }}>
            ...
            <div class="form-group row">
                ...
                <div class="col-12">
                    <select class="select2-basic-with-search form-control form-control-sm select2-preselected"
                        ...
                        data-preselected="{{ $defaults->defaults_timezone ?? ''}}">
                        <optgroup label="UTC">
            ...
            <div class="form-group row">
                ...
                <div class="col-12">
                    <select class="select2-basic form-control form-control-sm" id="defaults_date_format"
                        ...
                        <option value="d-m-Y" {{ runtimePreselected('d-m-Y', $defaults->defaults_date_format ?? '') }}>
                            d-m-Y</option>
                        <option value="d/m/Y" {{ runtimePreselected('d/m/Y', $defaults->defaults_date_format ?? '') }}>
                            d/m/Y</option>
                        <option value="m-d-Y" {{ runtimePreselected('m-d-Y', $defaults->defaults_date_format ?? '') }}>
                            m-d-Y</option>
                        <option value="m/d/Y" {{ runtimePreselected('m/d/Y', $defaults->defaults_date_format ?? '') }}>
                            m/d/Y</option>
                        <option value="Y-m-d" {{ runtimePreselected('Y-m-d', $defaults->defaults_date_format ?? '') }}>
                            Y-m-d</option>
                        <option value="Y/m/d" {{ runtimePreselected('Y/m/d', $defaults->defaults_date_format ?? '') }}>
                            Y/m/d</option>
                        <option value="Y-d-m" {{ runtimePreselected('Y-d-m', $defaults->defaults_date_format ?? '') }}>
                            Y-d-m</option>
                        <option value="Y/d/m" {{ runtimePreselected('Y/d/m', $defaults->defaults_date_format ?? '') }}>
                            Y/d/m</option>
                    </select>
                ...
                <div class="col-12">
                    <select class="select2-basic form-control form-control-sm" id="defaults_datepicker_format"
                        ...
                        <option value="dd-mm-yyyy"
                            {{ runtimePreselected('dd-mm-yyyy', $defaults->defaults_datepicker_format ?? '') }}>
                            dd-mm-yyyy</option>
                        <option value="mm-dd-yyyy"
                            {{ runtimePreselected('mm-dd-yyyy', $defaults->defaults_datepicker_format ?? '') }}>
                            mm-dd-yyyy</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-12">
                    ...
                    <select class="select2-basic form-control form-control-sm select2-preselected"
                        id="defaults_currency_code" data-preselected="{{ $defaults->defaults_currency_code ?? ''}}"
            ...
            <div class="form-group row">
                ...
                <div class="col-12">
                    <input type="text" class="form-control form-control-sm" id="defaults_currency_symbol"
                        name="defaults_currency_symbol" value="{{ $defaults->defaults_currency_symbol }}">
                </div>
            </div>
                ...
                <div class="col-12">
                    <select class="select2-basic form-control form-control-sm" id="defaults_decimal_separator"
                        ...
                        <option value="fullstop"
                            {{ runtimePreselected('fullstop', $defaults->defaults_decimal_separator ?? '') }}>
                            . ({{ cleanLang(__('lang.full_stop')) }})</option>
                        <option value="comma"
                            {{ runtimePreselected('comma', $defaults->defaults_decimal_separator ?? '') }}>
            ...
            <div class="form-group row">
                <label
                    class="col-12 control-label col-form-label">{{ cleanLang(__('lang.thousands_separator')) }}</label>
                <div class="col-12">
                    <select class="select2-basic form-control form-control-sm" id="defaults_thousand_separator"
                        name="defaults_thousand_separator">
                        <option value="fullstop"
                            {{ runtimePreselected('fullstop', $defaults->defaults_thousand_separator ?? '') }}>
                            . ({{ cleanLang(__('lang.full_stop')) }})</option>
                        <option value="comma"
                            {{ runtimePreselected('comma', $defaults->defaults_thousand_separator ?? '') }}>
                            , ({{ cleanLang(__('lang.comma')) }})</option>
                        <option value="apostrophe"
                            {{ runtimePreselected("apostrophe", $defaults->defaults_thousand_separator ?? '') }}>
                            ' ({{ cleanLang(__('lang.apostrophe')) }})</option>
                        <option value="none"
                            {{ runtimePreselected('none', $defaults->defaults_thousand_separator ?? '') }}>
                            {{ cleanLang(__('lang.none')) }}</option>
                        <option value="space"
                            {{ runtimePreselected('space', $defaults->defaults_thousand_separator ?? '') }}>
            ...
            <div class="form-group row">
                ...
                <div class="col-12">
                    <select class="select2-basic form-control form-control-sm" id="defaults_currency_position"
                        ...
                        <option value="left"
                            {{ runtimePreselected('left', $defaults->defaults_currency_position ?? '') }}>
                            {{ cleanLang(__('lang.left')) }}</option>
                        <option value="right"
                            {{ runtimePreselected('right', $defaults->defaults_currency_position ?? '') }}>
                ...
                <div class="col-12">
                    <select class="select2-basic form-control form-control-sm" id="defaults_email_delivery"
                        ...
                        <option value="smtp_only"
                            {{ runtimePreselected('smtp_only', $defaults->defaults_email_delivery ?? '') }}>
                            {{ cleanLang(__('lang.smtp_only')) }}</option>
                        <option value="smtp_and_sendmail"
                            {{ runtimePreselected('smtp_and_sendmail', $defaults->defaults_email_delivery ?? '') }}>
                            {{ cleanLang(__('lang.smtp_and_sendmail')) }}</option>
                    </select>
                </div>
            </div>
