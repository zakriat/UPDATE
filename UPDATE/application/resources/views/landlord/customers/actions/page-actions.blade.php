...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center text-right {{ $page['list_page_actions_size'] ?? '' }} {{ $page['list_page_container_class'] ?? '' }}"
    ...
    <div id="list-page-actions">
        ...
        <button type="button"
            ...
            data-toggle="modal" data-target="#commonModal" data-url="{{ url('/app-admin/customers/create') }}"
            data-loading-target="commonModalBody" data-modal-title="@lang('lang.add_new_customer')"
            data-action-url="{{ url('/app-admin/customers') }}"
