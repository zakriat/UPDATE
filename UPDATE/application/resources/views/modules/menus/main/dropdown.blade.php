...
<li data-modular-id="{{ $menu['id'] }}" class="sidenav-menu-item has-submenu" data-menu-wrapper-id="{{ $menu['id'] }}">
    <a class="has-arrow waves-effect waves-dark {{ $menu['class'] }}" href="javascript:void(0);"
        aria-expanded="false" id="{{ $menu['id'] }}">
        <i class="{{ $menu['icon'] }}"></i>
