...
<form class="form">
    ...
    <div class="form-group form-group-checkbox row">
        ...
        <div class="col-8 p-t-5">
            <input type="checkbox" id="settings_fooo_bar" name="settings_fooo_bar" class="filled-in chk-col-light-blue"
                {{ runtimePrechecked($settings['settings_fooo_bar'] ?? '') }}>
            <label for="settings_fooo_bar"></label>
        </div>
    </div>
