...
<form class="form" id="settingsFormCurrency">
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            ...
            <select class="select2-basic form-control form-control-sm select2-preselected"
                ...
                data-preselected="{{ $settings->settings_system_currency_code ?? ''}}"
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-3 col-form-label">@lang('lang.hide_decimal_points')</label>
        <div class="col-9 p-t-5">
            <input type="checkbox" id="settings_system_currency_hide_decimal" name="settings_system_currency_hide_decimal"
                ...
                {{ runtimePrechecked($settings->settings_system_currency_hide_decimal ?? '') }}>
