<div class="card-group table-stats-cards  {{ runtimePreferenceStatsPanelPosition(auth()->user()->stats_panel_position) }}"
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="progress">
                        <div class="progress-bar {{ $stats[0]['color'] ?? '' }} h-px-4 w-100"
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="progress">
                        <div class="progress-bar {{ $stats[1]['color'] ?? '' }} h-px-4  w-100"
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="progress">
                        <div class="progress-bar {{ $stats[2]['color'] ?? '' }} h-px-4  w-100"
