...
/** --------------------------------------------------------------------------------
 * This response renders the dom form for displaying a fooo.
...
class ShowResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        //render the page for the fooo and add it to the json object
        $html = view('pages/fooos/components/modals/show', compact('page'))->render();
        ...
        //hide modal footer
        $jsondata['dom_visibility'][] = array('selector' => '#commonModalFoooter', 'action' => 'hide');
