...
/** --------------------------------------------------------------------------------
 * This classes renders the response for the [update] process for the subscriptions
 * controller
 * @package    Grow CRM
 * @author     NextLoop
 *----------------------------------------------------------------------------------*/
...
class PinningResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        $jsondata['dom_move_element'][] = array(
            'element' => "#subscription_$subscription_id",
            'newparent' => '#subscriptions-td-container',
