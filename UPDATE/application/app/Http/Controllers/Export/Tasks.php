...
class Tasks extends Controller {
     ...
     * @return download
     */
    public function index(TasksExport $export) {

        //temp directory
        $directory = Str::random(30);

        //file name
        $filename = __('lang.tasks') . '.xlsx';
        ...
        try {
            ...
            Log::error("exporting tasks failed", ['process' => '[permissions]', config('app.debug_ref'), 'function' => __function__, 'file' => basename(__FILE__), 'line' => __line__, 'path' => __file__, 'error_message' => $error_message]);
            //default error
