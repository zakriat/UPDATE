...
class Index {
    ...
    public function handle($request, Closure $next) {
        ...
        //permission denied
        Log::error("permission denied", ['process' => 'middleware.fooos.index', 'ref' => config('app.debug_ref'), 'function' => __function__, 'file' => basename(__FILE__), 'line' => __line__, 'path' => __file__]);
        abort(403);
    }
