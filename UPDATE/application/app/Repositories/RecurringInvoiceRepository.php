...
class RecurringInvoiceRepository {
    ...
    public function processInvoices($limit = 1) {
        ...
        //invoice
        Log::info("found (" . count($invoices) . ") recurring invoices", ['process' => '[recurring-invoices-cronjob]', config('app.debug_ref'), 'function' => __function__, 'file' => basename(__FILE__), 'line' => __line__, 'path' => __file__]);
