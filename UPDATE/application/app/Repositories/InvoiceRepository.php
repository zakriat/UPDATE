    ...
    public function search($id = '', $data = array()) {
        ...
        if (in_array(request('sortorder'), array('desc', 'asc')) && request('orderby') != '') {
            ...
            if (Schema::hasColumn('invoices', request('orderby'))) {
                $invoices->orderByRaw('CASE WHEN pinned.pinned_id IS NOT NULL THEN 1 ELSE 0 END DESC')
            ...
            case 'balance':
                $invoices->orderByRaw('CASE WHEN pinned.pinned_id IS NOT NULL THEN 1 ELSE 0 END DESC')
                    ->orderBy('invoice_balance', request('sortorder'));
                break;
            case 'category':
                $invoices->orderByRaw('CASE WHEN pinned.pinned_id IS NOT NULL THEN 1 ELSE 0 END DESC')
            ...
            case 'client_contact':
                $invoices->orderByRaw('CASE WHEN pinned.pinned_id IS NOT NULL THEN 1 ELSE 0 END DESC')
                    ->orderBy('contact_name', request('sortorder'));
                break;
            case 'created_by':
                $invoices->orderByRaw('CASE WHEN pinned.pinned_id IS NOT NULL THEN 1 ELSE 0 END DESC')
            ...
            case 'last_payment_date':
                $invoices->orderByRaw('CASE WHEN pinned.pinned_id IS NOT NULL THEN 1 ELSE 0 END DESC')
                    ->orderBy('last_payment_date', request('sortorder'));
                break;
            case 'last_payment_amount':
                $invoices->orderByRaw('CASE WHEN pinned.pinned_id IS NOT NULL THEN 1 ELSE 0 END DESC')
                    ->orderBy('last_payment_amount', request('sortorder'));
                break;
            case 'last_payment_method':
                $invoices->orderByRaw('CASE WHEN pinned.pinned_id IS NOT NULL THEN 1 ELSE 0 END DESC')
                    ->orderBy('last_payment_method', request('sortorder'));
                break;
            case 'last_payment_transaction_id':
                $invoices->orderByRaw('CASE WHEN pinned.pinned_id IS NOT NULL THEN 1 ELSE 0 END DESC')
                    ->orderBy('last_payment_transaction_id', request('sortorder'));
                break;
            case 'attachments':
                $invoices->orderByRaw('CASE WHEN pinned.pinned_id IS NOT NULL THEN 1 ELSE 0 END DESC')
                    ->orderBy('count_attachments', request('sortorder'));
                break;
            }
        } else {
            //default sorting
