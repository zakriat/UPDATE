            ...
            foreach (request('standard_field') as $key => $value) {
                if ($value == 'on') {
                    ...
                    case 'bill_projectid':
                        ...
                        break;
                    case 'bill_subtotal':
                        $map[] = runtimeExcelNumberFormat($estimates->bill_subtotal);
                        break;
                    ...
                    case 'bill_discount_amount':
                        $map[] = runtimeExcelNumberFormat($estimates->bill_discount_amount);
                        break;
                    case 'bill_amount_before_tax':
                        $map[] = runtimeExcelNumberFormat($estimates->bill_amount_before_tax);
                        break;
                    case 'bill_tax_total_amount':
                        $map[] = runtimeExcelNumberFormat($estimates->bill_tax_total_amount);
                        break;
                    case 'bill_adjustment_description':
                        $map[] = $estimates->bill_adjustment_description;
                        break;
                    case 'bill_adjustment_amount':
                        $map[] = runtimeExcelNumberFormat($estimates->bill_adjustment_amount);
                        break;
                    case 'bill_final_amount':
                        $map[] = runtimeExcelNumberFormat($estimates->bill_final_amount);
                        break;
