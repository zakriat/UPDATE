...
class Leads extends Controller {
     ...
     * @return download
     */
    public function index(LeadsExport $export) {

        //temp directory
        $directory = Str::random(30);

        //file name
        $filename = __('lang.leads') . '.xlsx';
        ...
        try {
            ...
            Log::error("exporting leads failed", ['process' => '[permissions]', config('app.debug_ref'), 'function' => __function__, 'file' => basename(__FILE__), 'line' => __line__, 'path' => __file__, 'error_message' => $error_message]);
            //default error
