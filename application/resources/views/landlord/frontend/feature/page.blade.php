        ...
        <form class="form" id="settingsForm">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12">
                    <textarea class="form-control form-control-sm tinymce-textarea" rows="15"
                        ...
                        id="frontend_data_3">{{ $section->frontend_data_3 ?? '' }}</textarea>
                </div>
            </div>
            ...
            <div class="text-right">
                <button type="submit" class="btn btn-rounded-x btn-danger btn-sm waves-effect text-left ajax-request"
                    data-url="{{ url('/app-admin/frontend/section/'.request()->segment(4).'/feature') }}" data-form-id="landlord-settings-form"
