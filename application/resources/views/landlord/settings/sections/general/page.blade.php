...
<div class="card">
    <div class="card-body" id="landlord-settings-form">
        ...
        <form class="form" id="settingsFormGeneral">
            ...
            <div class="form-group row">
                <label class="col-12 control-label col-form-label">{{ cleanLang(__('lang.purchase_code')) }}
                    <span class="align-middle" data-toggle="tooltip"
                        title="{{ cleanLang(__('lang.product_purchase_code')) }}" data-placement="top"><i
            ...
            <div class="form-group row">
                ...
                <div class="col-12">
                    <select class="select2-basic-with-search form-control form-control-sm select2-preselected"
                        ...
                        data-preselected="{{ $settings->settings_system_timezone ?? ''}}">
                        <optgroup label="UTC">
            ...
            <div class="form-group row">
                <label class="col-12 control-label col-form-label">{{ cleanLang(__('lang.renewal_grace_period')) }}
                    <span class="align-middle" data-toggle="tooltip"
                        title="{{ cleanLang(__('lang.the_numer_of_days_grace_period')) }}" data-placement="top"><i
                            class="ti-info-alt text-themecontrast"></i></span></label>
                <div class="col-12">
                    <div class="input-group input-group-sm input-group-both">
                        <input type="number" class="form-control" id="settings_system_renewal_grace_period"
                            ...
                            value="{{ $settings->settings_system_renewal_grace_period ?? ''  }}">
            ...
            <div class="spacer row m-t-40">
                <div class="col-sm-12 col-lg-8">
                    <span class="title">@lang('lang.terms_of_service')</span>
                </div>
            ...
            <div class="hidden p-t-10" id="toogle_terms_of_service">
                ...
                <div class="form-group row">
                    <div class="col-lg-12">
                        <textarea class="form-control form-control-sm tinymce-textarea" rows="5"
                            ...
                            id="settings_terms_of_service">{{ $settings->settings_terms_of_service ?? '' }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label
                        class="col-lg-12 text-left control-label col-form-label">@lang('lang.terms_of_service_text')</label>
                    <div class="col-lg-12">
                        <input type="text" class="form-control form-control-sm" id="settings_terms_of_service_text"
                            name="settings_terms_of_service_text"
                            value="{{ $settings->settings_terms_of_service_text ?? '' }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label
                        class="col-lg-12 text-left control-label col-form-label">@lang('lang.terms_of_service_status')</label>
                    <div class="col-lg-12">
                        <select class="select2-basic form-control form-control-sm select2-preselected"
                            ...
                            data-preselected="{{ $settings->settings_terms_of_service_status ?? ''}}">
                            <option></option>
            ...
            <div class="text-right m-t-30">
                <button type="submit" id="commonModalSubmitButton"
                    ...
                    data-url="{{ url('app-admin/settings/general') }}" data-form-id="landlord-settings-form"
