...
<tr class="customfields-table-settings hidden toggle-table-settings-row  toggle-table-settings-row-{{ $field->customfields_id }}"
    ...
    <td class="b-0">
        <div class="row">
            ...
            <!--show on ticket page-->
            <div class="col-4">
                <input type="checkbox" id="customfields_show_ticket_page[{{ $field->customfields_id }}]"
                    name="customfields_show_ticket_page[{{ $field->customfields_id }}]"
                    class="filled-in chk-col-light-blue" {{ runtimePrechecked($field->customfields_show_ticket_page) }}>
                <label
                    for="customfields_show_ticket_page[{{ $field->customfields_id }}]">@lang('lang.show_on_ticket')</label>
            </div>
