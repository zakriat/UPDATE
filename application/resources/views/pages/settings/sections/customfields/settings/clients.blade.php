@if(request('customfields_type') == 'clients')
        ...
        <div class="row">
            ...
            <div class="col-4">
                <input type="checkbox" id="customfields_show_client_page[{{ $field->customfields_id }}]"
                    ...
                    class="filled-in chk-col-light-blue" {{ runtimePrechecked($field->customfields_show_client_page) }}>
                <label
                    for="customfields_show_client_page[{{ $field->customfields_id }}]">@lang('lang.show_profile')</label>
            </div>
            <!--show on invoice-->
            <div class="col-4">
                <input type="checkbox" id="customfields_show_invoice[{{ $field->customfields_id }}]"
                    name="customfields_show_invoice[{{ $field->customfields_id }}]" class="filled-in chk-col-light-blue"
                    {{ runtimePrechecked($field->customfields_show_invoice) }}>
                <label for="customfields_show_invoice[{{ $field->customfields_id }}]">@lang('lang.show_invoice')</label>
            </div>
            <!--show in filter-->
            <div class="col-4">
            ...
            <div class="col-4">
                <div class="switch" id="customfields_settings_status_{{ $field->customfields_id }}">
                    @lang('lang.status')
                    <label>
                        <input {{ runtimePrechecked($field->customfields_status ?? '') }} type="checkbox"
